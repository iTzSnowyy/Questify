...
if (fightBtn) {
  fightBtn.addEventListener("click", async () => {
    ...
    const bossPower = 100; // Slacking Dragon baseline (change between 20 and more than 20 to see different outcomes)
    ...
    if (playerPower >= bossPower) {
      ...
      bossResult.textContent = `You were defeated... Your power (${playerPower}) is lower than the boss 
      (${bossPower}). Try leveling up or improving your stats.`;
    }
  });
}
